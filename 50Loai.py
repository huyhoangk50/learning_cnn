...
organ = 'leaf'
data_folder = '../50_species_simple_collection/' + organ
...
with graph.as_default():
    ...
    x_test = test_dir #list of testing data path
    x_valid = svm_dir #list of svm data path
    x_train = train_dir #list of training data path
    ...
    x_test = tf.image.resize_images(x_test, [227, 227], method=1)#resize image
